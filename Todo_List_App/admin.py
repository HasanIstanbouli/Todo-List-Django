...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        (
            "Personal info",
            {"fields": ("firstName", "lastName", "email", "phone", "address", "email_verified")},
        ),
        (
            "Permissions",
...
class TaskAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("taskTitle", "description", "category")}),
        ("Date Information", {"fields": ("dueDate", "createdDate", "completedDate")}),
        ("Status", {"fields": ("important", "status")}),
        ("User Information", {"fields": ("user",)}),
        ("Notification", {"fields": ("notificationTime", "sent_reminder", "emailNotification")}),
    )
